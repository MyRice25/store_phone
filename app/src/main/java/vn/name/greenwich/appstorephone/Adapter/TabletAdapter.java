...
public class TabletAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabletAdapter(Context context, List<Product> array) {
...
//            myViewHolder.id.setText(product.getId() + "");
            ...
            myViewHolder.setItemClickListener(new ItemClickListener() {
                ...
                public void onClick(View view, int pos, boolean isLongClick) {
                    if (!isLongClick){
                        // click vao san pham chuyển qua trang chi tiết
                        Intent intent = new Intent(context, DetailActivity.class);
                        intent.putExtra("Detail", product);  // dòng chuyển tiếp sản phẩm cho bên ChiTietActivity
